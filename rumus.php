<?php
session_start();
require 'koneksi.php';  // Ensure the connection file is working
...
if (isset($_POST['delete_student'])) {
    ...
    if ($query_run) {
        ...
        $_SESSION['pesan'] = "Hapus data mahasiswa tidak berhasil: " . mysqli_error($con);
    }
...
if (isset($_POST['update_student'])) {
    ...
    if ($query_run) {
        ...
        $_SESSION['pesan'] = "Update siswa tidak berhasil: " . mysqli_error($con);
    }
    header("Location: index.php");
    exit(0);
}
...
if (isset($_POST['save_student'])) {
    ...
    if ($query_run) {
        ...
        $_SESSION['pesan'] = "Tambah siswa tidak berhasil: " . mysqli_error($con);
    }
